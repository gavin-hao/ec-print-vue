...
import { App, inject, InjectionKey, reactive, Ref, ref, unref } from 'vue';
...
const printerKey = Symbol('ec-printer') as InjectionKey<EcPrinter>;
const printerStatusKey = Symbol('ec-printer-status') as InjectionKey<Ref<PrinterStatus>>;
